  ...
  return (
    <div id="hero" className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      ...
      className = 'inline-flex items-center gap-2 border border-gray-300 p-1.5 pr-4 rounded-full'>
        ...
        xl:leading-[95px] max-w-5xl'>Connecting the right poeple with <span className='bg-gradient-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent'>right</span> talent.</motion.h1>
        ...
        viewport={{once:true}}
         className='text-sm sm:text-lg font-medium text-gray-500 dar:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>From permanent to virtual staffing, we match the right person to the right role.</motion.p>
